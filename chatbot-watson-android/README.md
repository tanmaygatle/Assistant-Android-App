...
WatBot is an IBM Watson powered ChatBot running on Android and using Watson Assistant (formerly Conversation), Text-to-Speech, Speech-to-Text Services on IBM Cloud (an open standards, cloud platform for building, running, and managing apps and services).
...
<resources>
    <!-- Watson Assistant (formerly Conversation) Service Credentials --> 
...
You use the Watson Assistant (formerly Conversation) tool to create workspaces by either creating a new workspace from scratch, or  by importing a workspace from a [JSON](https://github.com/IBM-Cloud/chatbot-watson-android/blob/master/sample.json) file. You can also duplicate an existing workspace within the same service instance.
<ol>
